<link rel="stylesheet" href="{{ asset('css/components/trends-chart.css') }}">
...
<script>
    ...
    const trendsChartData = {
        ...
        appointmentsData: @json($appointmentsData),
        patientsData: @json($patientsData),
        chartLabels: @json($chartLabels)
    };
</script>
<script src="{{ asset('js/admin/trends-chart.js') }}"></script>
