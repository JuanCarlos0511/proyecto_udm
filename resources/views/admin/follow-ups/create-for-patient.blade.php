...
@section('page-title', 'Crear Seguimiento')

@section('breadcrumb')
    <span class="breadcrumb-separator">/</span>
    <span><a href="{{ url('admin/tablero') }}">Tablero</a></span>
    <span class="breadcrumb-separator">/</span>
    <span><a href="{{ route('admin.patients.index') }}">Pacientes</a></span>
    <span class="breadcrumb-separator">/</span>
...
<div class="form-container">
    <h2 class="form-title">Crear Seguimiento para Paciente</h2>
    ...
    <div class="patient-info">
        <div class="patient-avatar">
            @if($patient->photo_path)
                <img src="{{ asset($patient->photo_path) }}" alt="{{ $patient->name }}">
            @else
                <img src="{{ asset('assets/default-avatar.png') }}" alt="{{ $patient->name }}">
            @endif
        </div>
    ...
    <form id="followUpForm" action="{{ route('follow-ups.store') }}" method="POST">
        ...
        <div class="form-actions">
            <a href="{{ route('admin.patients.show', $patient->id) }}" class="btn-cancel">Cancelar</a>
            <button type="submit" class="btn-submit">Crear Seguimiento</button>
        </div>
    </form>
</div>
@endsection
